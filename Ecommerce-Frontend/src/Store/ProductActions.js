...
const getProducts = createAsyncThunk("gets/getProducts", async (data,{rejectWithValue}) => {
    try {
        ...
        let link=`http://localhost:4000/product?keyword=${keyword}&page=${currentPage}&ratings[gte]=${rating[0]}&ratings[lte]=${rating[1]}&price[gte]=${price[0]}&price[lte]=${price[1]}`;
        if(Category){
            link=`http://localhost:4000/product?keyword=${keyword}&page=${currentPage}&ratings[gte]=${rating[0]}&ratings[lte]=${rating[1]}&price[gte]=${price[0]}&price[lte]=${price[1]}&category=${Category}`;
        }
...
const addReview = createAsyncThunk("put/putReview", async (data,{rejectWithValue}) => {
    try {
        ...
        const response = await axios.put(`http://localhost:4000/review`,data,confiq);
        return response.data;
    } catch (error) {
        return rejectWithValue(error.response.data);
    }
...
const getAllProducts = createAsyncThunk("gets/getAllProducts", async (data,{rejectWithValue}) => {
    try {
        const response = await axios.get(`http://localhost:4000/admin/products`,{withCredentials:true});
        return response.data;
    } catch (error) {
        return rejectWithValue(error.response.data);
    }
...
const newProduct = createAsyncThunk("post/postnewProduct", async (data,{rejectWithValue}) => {
    try {
        ...
        const response = await axios.post('http://localhost:4000/admin/product/new',data,config);
        return response.data;
    } catch (error) {
        return rejectWithValue(error.response.data);
    }
...
const deleteProduct = createAsyncThunk("delete/deleteProduct", async (id,{rejectWithValue}) => {
    try {
        const response = await axios.delete(`http://localhost:4000/admin/product/${id}`,{withCredentials:true});
        return response.data;
    } catch (error) {
        return rejectWithValue(error.response.data);
    }
...
const updateProduct = createAsyncThunk("update/updateProduct", async (data,{rejectWithValue}) => {
    try {
        const config={headers:{"Content-Type":"multipart/form-data"},withCredentials:true};
        const response = await axios.put(`http://localhost:4000/admin/product/${data.id}`,data.form,config);
        return response.data;
    } catch (error) {
        return rejectWithValue(error.response.data);
    }
...
const getAllReviews = createAsyncThunk("get/getReviews", async (id,{rejectWithValue}) => {
    try {
        const response = await axios.get(`http://localhost:4000/admin/reviews?product_Id=${id}`,{withCredentials:true});
        return response.data;
    } catch (error) {
        return rejectWithValue(error.response.data);
    }
...
const deleteReview = createAsyncThunk("delete/deleteReview", async (data,{rejectWithValue}) => {
    try {
        const response = await axios.delete(`http://localhost:4000/admin/review/delete?product_Id=${data.product_Id}&review_Id=${data.review_Id}`,{withCredentials:true});
        return response.data;
    } catch (error) {
        return rejectWithValue(error.response.data);
    }
