...
const loggedIn = createAsyncThunk("post/postuserDetail", async (data,{rejectWithValue}) => {
    try {
        ...
        const response = await axios.post('http://apnaplaza.herokuapp:4000/logIn',data,config);
...
const register = createAsyncThunk("post/postuserRegisterDetail", async (data,{rejectWithValue}) => {
    try {
        ...
        const response = await axios.post('http://apnaplaza.herokuapp:4000/register',data,config);
        return response.data;
    } catch (error) {
        return rejectWithValue(error.response.data.message);
    }
...
const loadUser = createAsyncThunk("get/getuserDetail", async (data,{rejectWithValue}) => {
    try {
        const response = await axios.get('http://apnaplaza.herokuapp:4000/profile',{withCredentials:true});
        return response.data;
    } catch (error) {
        return rejectWithValue(error.response.data.message);
    }
...
const logOutUser= createAsyncThunk("get/getLogOut", async (data,{rejectWithValue}) => {
    try {
        const response = await axios.get('http://apnaplaza.herokuapp:4000/logOut',{withCredentials:true});
        return response.data;
    } catch (error) {
        return rejectWithValue(error.response.data.message);
    }
...
const updateProfile = createAsyncThunk("update/updateProfile", async (data,{rejectWithValue}) => {
    try {
        const config={headers:{"Content-Type":"multipart/form-data"},withCredentials:true};
        const response = await axios.put('http://apnaplaza.herokuapp:4000/profile/update',data,config);
        return response.data;
    } catch (error) {
        return rejectWithValue(error.response.data.message);
    }
...
const updatePassword = createAsyncThunk("update/updatePassword", async (data,{rejectWithValue}) => {
    try {
        const config={headers:{"Content-Type":"application/json"},withCredentials:true};
        const response = await axios.put('http://apnaplaza.herokuapp:4000/profile/updatePassword',data,config);
        return response.data;
    } catch (error) {
        return rejectWithValue(error.response.data.message);
    }
...
const getAllUsers= createAsyncThunk("get/getAllUsers", async (data,{rejectWithValue}) => {
    try {
        const response = await axios.get('http://apnaplaza.herokuapp:4000/admin/users',{withCredentials:true});
        return response.data;
    } catch (error) {
        return rejectWithValue(error.response.data.message);
    }
...
const getUserDetail= createAsyncThunk("get/getUserDetail", async (id,{rejectWithValue}) => {
    try {
        const response = await axios.get(`http://apnaplaza.herokuapp:4000/admin/user/${id}`,{withCredentials:true});
        return response.data;
    } catch (error) {
        return rejectWithValue(error.response.data.message);
    }
...
const deleteUser= createAsyncThunk("delete/deleteUser", async (id,{rejectWithValue}) => {
    try {
        const response = await axios.delete(`http://apnaplaza.herokuapp:4000/admin/user/${id}`,{withCredentials:true});
        return response.data;
    } catch (error) {
        return rejectWithValue(error.response.data.message);
    }
...
const updateUser= createAsyncThunk("update/updateUser", async (data,{rejectWithValue}) => {
    try {
        const response = await axios.put(`http://apnaplaza.herokuapp:4000/admin/user/${data.id}`,data.form,{withCredentials:true});
        return response.data;
    } catch (error) {
        return rejectWithValue(error.response.data.message);
    }
